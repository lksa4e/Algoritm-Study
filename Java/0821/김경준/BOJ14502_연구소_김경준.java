 ...
 * N, M의 범위가 3 <=N, M <= 8 이므로 빈 공간의 최대 개수는 24를 넘지 않는다.
 * 따라서 전체 벽을 세우는 경우의 수를 고려하여도 24C3 보다 작은 수가 된다.
 * 벽을 세운 각 경우에 BFS를 통해 탐색하여도 최대 이동 가능한 경우는 24밖에 없다.(실제는 벽때문에 얼마 못감)
 * ==> 대충계산 24^4 < 1,000,000
 */
