 ...
 * 
 * 5번 내부를 어떻게 구해보려다가 머리아파서 구냥 1,2,3,4번을 구하고 나머지를 5번으로 하였음
 * 조건에 따라 완탐을 하여 최적의 x, y, d1, d2을 찾아야 하는데 조건을 코드로 제대로 도출해내는게 힘들었음...
 * 그리고 1,2,3,4,5번 섹터의 경계가 서로 물리고 안물리고 그 부분이 상당히 헷갈림
 * 
 * 메모리 	시간
 * 17732   224
 */
